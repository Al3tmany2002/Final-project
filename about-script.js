...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // 1. تأثير الصفحة الأولى (عنوان About Us)
    ...
    // 2. ربط حركة الصورة بالسكرول مباشرة في الصفحة الثانية
    ...
    // 4. تأثير ظهور الثلاث صور (.journey-card) مع السكرول
